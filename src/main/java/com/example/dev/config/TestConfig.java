...
import com.example.dev.entities.Order.OrderStatus;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {   
		...
		Product p1 = new Product(null, "Lord of the Rings", "Lorem ipsum dolor sit amet", 90.5, "");  
		Product p2 = new Product(null, "Smart TV", "Lorem ipsum dolor sit amet", 2190.5, ""); 
		Product p3 = new Product(null, "Macbook Pro", "Lorem ipsum dolor sit amet", 1250.0, "");
		Product p4 = new Product(null, "PC Gamer", "Lorem ipsum dolor sit amet", 1200.0, ""); 
		Product p5 = new Product(null, "Lord of the Rings", "Lorem ipsum dolor sit amet", 100.99, ""); 
